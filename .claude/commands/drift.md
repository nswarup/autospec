...
**Prerequisite:** Requires `spec.md` (generated by `/spec`). `design.md` makes the analysis much richer. If `spec.md` is missing from the feature directory, tell the user to run `/spec` first.
