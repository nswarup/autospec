...
**Prerequisite:** Requires `spec.md` (generated by `/spec`). If it doesn't exist in the feature directory, tell the user to run `/spec` first.
...
- Key findings from the proposal's **Prior Art & Market Research** section — how do comparable products handle this technically? What patterns should we adopt or avoid?
